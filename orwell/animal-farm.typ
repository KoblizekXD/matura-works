...
#work(
  ...
  year: 1945,
  literary-context: [
    Dílo se odehrává v 50. letech 20. století, po druhé světové válce, na vzestupu
    totalitních režimů, zejména komunismu ve východní Evropě a fašismu v Itálii a Německu. V této době se objevovala silná kritika těchto režimů a jejich praktik, což se odráží i v Orwellově díle. Farma zvířat byla napsána jako alegorie na ruskou revoluci a vznik Sovětského svazu, přičemž zvířata na farmě představují různé sociální třídy a politické postavy té doby.
  ],
  characteristics: [
    Dílo kritizuje totalitní režimy a zobrazuje, jak se ideály mohou zvrhnout v tyranii. Používá alegorii, kde zvířata představují různé sociální a politické skupiny. Hlavními tématy jsou moc, korupce, propaganda a zrada ideálů.

    Dílo je psáno v er-formě, žánrově se jedná o románovou alegorii s prvky bajky a satiru. Odehrává se v 50. letech 20. století na farmě v Anglii s chronologickým příběhem.

    Je psáno spisovným jazykem, používá hodně dialogů (přímá řeč) a občasně hovorové výrazy.
  ],
  plot-and-motifs: [
    ==== Děj
  ...
  additional-info: [
    ...
    Mezi klíčové prvky patřily:
    - Neskutečné světy
    - Fiktivní vize budoucnosti a vědy
